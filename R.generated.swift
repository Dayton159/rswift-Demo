...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      ///
      /// Locales: en, id
      static let english = Rswift.StringResource(key: "english", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en", "id"], comment: nil)
      /// en translation: Fox
      ///
      /// Locales: en, id
      ...
      ///
      /// Locales: en, id
      static let indonesia = Rswift.StringResource(key: "indonesia", tableName: "Localizable", bundle: R.hostingBundle, locales: ["en", "id"], comment: nil)
      ...
      static func indonesia(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("indonesia", bundle: hostingBundle, comment: "")
        }
        ...
        return NSLocalizedString("indonesia", bundle: bundle, comment: "")
      }
